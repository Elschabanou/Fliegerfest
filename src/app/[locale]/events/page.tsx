...
const EventsMap = lazy(() =>
  import("@/components/EventsMap").then((mod) => ({default: mod.default})),
);
...
export default function EventsPage() {
  ...
  const isPastEvent = (e: Event) => {
    ...
    const hasExplicitTime =
      (e.dateTime && /T\d{2}:\d{2}/.test(e.dateTime)) ||
      !!e.startTime ||
      !!e.endTime;
    if (!hasExplicitTime) {
        ...
        {loading ? (
          <div className="space-y-6">
            {showMap ? (
              <div className="mb-8 -mx-4 sm:mx-0">
                <h2 className="px-4 sm:px-0 text-2xl font-semibold text-[#021234] mb-4 mt-4">
                  {t("eventsOnMap")}
                </h2>
          ...
          <div className="mb-8 md:mb-8 -mx-4 sm:mx-0">
            <div className="px-4 sm:px-0 flex flex-col sm:flex-row sm:items-center sm:justify-between mb-4 mt-4 gap-4">
              <h2 className="text-2xl font-semibold text-[#021234]">
                {t("eventsOnMap")}
              </h2>
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-[#021234] mb-2">
              {t("noEventsFound")}
            </h3>
            ...
            {events.map((event) => (
              ...
              >
                ...
                <div className="flex flex-col flex-1 p-6">
                  ...
                  <h3 className="text-xl font-semibold text-[#021234] mb-2">
